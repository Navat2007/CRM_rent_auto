...
class HimeraService {
    static async sendRequest(f, i, o, birthday) {
        ...
        const response = await axios.postForm(`${import.meta.env.VITE_SERVICE_API_URL}/himera/check.php`, form);
    ...
    static async getResults(user_id) {
        ...
        const response = await axios.postForm(`${import.meta.env.VITE_SERVICE_API_URL}/himera/load.php`, form);
