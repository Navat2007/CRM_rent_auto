        ...
        <template #content>
            <Tabs :value="tabValue" scrollable>
                <TabList>
                    ...
                    <Tab value="2" class="flex gap-2">Проверки в odyssey</Tab>
                    <Tab value="3" class="flex gap-2">Проверки в himera</Tab>
                    <Tab value="4" class="flex gap-2">Проверки в api-cloud</Tab>
                </TabList>
                    ...
                    <TabPanels>
                        ...
                        <TabPanel value="2">
                            ...
                            <Table
                                ...
                                :filter-fields="odysseyFilterFields" :inCard="false"
                            >
                                <template #columns>
