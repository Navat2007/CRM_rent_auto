...
<template>
            ...
            <TabPanel value="0">
              <div class="grid gap-4 sm:grid-cols-1">
                ...
                <div>
                  ...
                  <Password id="password" v-model="state.password" placeholder="Введите пароль"
                            :toggleMask="true"
                ...
                <div>
                  <label for="confirmPassword"
                    ...
                    пароль*</label>
                  <Password id="confirmPassword" v-model="state.confirmPassword"
  ...
  <PopUpAddDirectoryPosition
      :visible="isPositionAddModalOpen" @on-add="onPositionAdd"
