...
const state = reactive({
  ...
  release_year: moment().year(),
  directory_car_brands_id: 0,
  directory_car_models_id: 0,
  directory_car_generations_id: 0,
  directory_car_configurations_id: 0,
  date_park_enter: null,
  date_park_exit: null,
  mileage: 0,
  directory_car_statuses_id: 1,
  body_condition: 0,
  ...
  failure: "",
  critical_failure: "",
  directory_car_bodies_id: 0,
  directory_car_fuel_types_id: 0,
  directory_car_wheel_drive_id: 0,
  directory_car_transmissions_id: 0,
  fuel_tank_capacity: "",
  fuel_consumption: "",
  directory_car_colors_id: 0,
  seats_count: 0,
  additional_parameter_1: "",
  additional_parameter_2: "",
  additional_parameter_3: "",

  characteristic_rear_view_camera: false,
  characteristic_front_parking_sensors: false,
  characteristic_rear_parking_sensors: false,
  characteristic_camera_360: false,
  characteristic_panorama: false,
  characteristic_AUX: false,
  characteristic_bluetooth: false,
  characteristic_carplay: false,
  characteristic_android_auto: false,
  characteristic_heated_seats: false,
  characteristic_heated_windshield: false,
  characteristic_driver_assistance: false,
  characteristic_railings: false,
  characteristic_isofix: false,
  characteristic_hatch: false,
  characteristic_cruise_control: false,
  characteristic_armrest: false,
  characteristic_airbag_switch: false,
  characteristic_directory_car_interior_materia_id: 0,
  characteristic_directory_car_colors_id: 0,
  characteristic_additional_parameter_1: "",
  characteristic_additional_parameter_2: "",
  characteristic_additional_parameter_3: "",

  to_directory_car_wheel_size_id: 0,
  to_directory_car_tires_type_id: 0,
  to_radio_code: "",
  to_secret: "",
  to_beacon_place_1: "",
  to_beacon_place_2: "",
  ...
  pts_number: "",
  pts_issued_by_who: "",
  pts_issued_date: null,
  pts_vin: "",
  pts_body_number: "",
  pts_purchase_date: null,
  pts_cost_assessment: "",
  pts_cost_purchase: "",
  pts_directory_car_pts_ownership_id: 0,
  pts_legal_person_id: 0,
  pts_files: [],
  pts_upload_files: [],

  sts_client_id: 0,
  sts_legal_person_id: 0,
  sts_series: "",
  sts_number: "",
  sts_issued_by_who: "",
  sts_issued_date: null,
  sts_expire_date: null,
  sts_files: [],
  sts_upload_files: [],
...
<template>
  <Card class="xl:w-8/12 w-full">
    <template #title>Добавить авто</template>
    <template #content>
          ...
          <TabPanels>
            <TabPanel value="0">
              <div class="grid gap-4 sm:grid-cols-1">
                <!-- Заглавное фото авто -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Заглавное фото
                    авто</label>
                ...
                <div>
                  <label for="state_number"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Гос номер</label>
                ...
                <div>
                  <label for="release_year"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Год выпуска</label>
                  <InputNumber id="release_year" v-model="state.release_year" :min="1900" :max="moment().year()"
                               :useGrouping="false" fluid/>
                </div>
                <!--  Марка авто -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Марка авто</label>
                  <Select v-model="state.directory_car_brands_id" :loading="loadingDirectoryBrands"
                          :options="directoryBrands"
                          optionLabel="name" optionValue="id" placeholder="Выберите марку авто" showClear filter
                          class="w-full"
                          @change="(e) => {
                            if(e.value === null)
                ...
                <div v-if="state.directory_car_brands_id !== 0">
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Модель авто</label>
                  <Select v-model="state.directory_car_models_id" :loading="loadingDirectoryModels"
                          ...
                          optionLabel="name" optionValue="id" placeholder="Выберите модель авто" showClear filter
                          class="w-full"
                          @change="(e) => {
                            if(e.value === null)
                              state.directory_car_models_id = 0;
                ...
                <div v-if="state.directory_car_models_id !== 0">
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Поколение авто</label>
                  <Select v-model="state.directory_car_generations_id" :loading="loadingDirectoryGenerations"
                          :options="directoryGenerations.filter(item => parseInt(item.directory_car_models_id) === state.directory_car_models_id)"
                          optionLabel="name"
                          optionValue="id" placeholder="Выберите поколение авто" showClear filter class="w-full">
                    <template v-if="user.access.auto === 2" #header>
                      <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                ...
                <!--  Комплектация авто -->
                <div v-if="state.directory_car_models_id !== 0">
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Комплектация авто</label>
                  <Select v-model="state.directory_car_configurations_id" :loading="loadingDirectoryConfigurations"
                          :options="directoryConfigurations.filter(item => parseInt(item.directory_car_models_id) === state.directory_car_models_id)"
                          optionLabel="name"
                          optionValue="id" placeholder="Выберите комплектацию авто" showClear filter class="w-full">
                    <template v-if="user.access.auto === 2" #header>
                      <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                ...
                <div>
                  <label for="date_park_enter"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Дата поступления в
                    парк</label>
                  <div>
                ...
                <div>
                  <label for="date_park_exit"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Дата исключения из
                    парка</label>
                  <div>
                ...
                <!-- Статус авто -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Статус авто</label>
                  <Select v-model="state.directory_car_statuses_id" :loading="loadingDirectoryStatuses"
                ...
                <Panel header="Состояние авто" toggleable collapsed>
                  <div class="grid gap-4 sm:grid-cols-1">
                    <!-- Состояние кузова -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Состояние кузова</label>
                      <Select v-model="state.body_condition" :options="conditions" :modelValue="state.body_condition" optionLabel="label"
                              optionValue="value" placeholder="Выберите состояние" class="w-full"/>
                    </div>
                    <!-- Состояние салона -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Состояние салона</label>
                      <Select v-model="state.interior_condition" :options="conditions" :modelValue="state.interior_condition" optionLabel="label"
                              optionValue="value" placeholder="Выберите состояние" class="w-full"/>
                    </div>
                    <!-- Состояние багажника -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Состояние багажника</label>
                      <Select v-model="state.trunk_condition" :options="conditions" :modelValue="state.trunk_condition" optionLabel="label"
                              optionValue="value" placeholder="Выберите состояние" class="w-full"/>
                    </div>
                    <!-- Нужно заправить -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Нужно заправить</label>
                      <Select v-model="state.need_refuel" :options="fuelLevels" :modelValue="state.need_refuel" optionLabel="label"
                              optionValue="value" placeholder="Выберите уровень топлива" class="w-full"/>
                    </div>
                    <!-- Нужно обслужить -->
                    <div>
                      <div class="flex items-center gap-2">
                        ...
                        <label for="need_service" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Нужно обслужить?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <Textarea id="failure" v-model="state.failure" rows="3" cols="30" autoResize fluid/>
                    </div>
                    <!-- Критическая неисправность -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Критическая неисправность</label>
                      <Textarea id="critical_failure" v-model="state.critical_failure" rows="3" cols="30" autoResize fluid/>
                    </div>
                  </div>
                </Panel>
                ...
                <Panel header="Характеристики" toggleable collapsed>
                  <div class="grid gap-4 sm:grid-cols-1">
                    <!--  Тип кузова -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Тип кузова</label>
                      <Select v-model="state.directory_car_bodies_id" :loading="loadingDirectoryCarBodies"
                              :options="directoryCarBodies"
                              optionLabel="name" optionValue="id" placeholder="Выберите тип кузова" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                    ...
                    <!--  Тип топлива -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Тип топлива</label>
                      <Select v-model="state.directory_car_fuel_types_id" :loading="loadingDirectoryCarFuelTypes"
                              :options="directoryCarFuelTypes"
                              optionLabel="name" optionValue="id" placeholder="Выберите тип топлива" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                    ...
                    <div>
                      ...
                      <Select v-model="state.directory_car_wheel_drive_id" :loading="loadingDirectoryCarWheelDrive"
                              :options="directoryCarWheelDrive"
                              optionLabel="name" optionValue="id" placeholder="Выберите привод" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                    ...
                    <div>
                      ...
                      <Select v-model="state.directory_car_transmissions_id" :loading="loadingDirectoryCarTransmissions"
                              :options="directoryCarTransmissions"
                              optionLabel="name" optionValue="id" placeholder="Выберите трансмиссию" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                    ...
                    <div>
                      <label for="fuel_tank_capacity"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Объем бака</label>
                      <InputText id="fuel_tank_capacity" v-model="state.fuel_tank_capacity" fluid/>
                    </div>
                    <!-- Расход топлива -->
                    <div>
                      <label for="fuel_consumption"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Расход топлива</label>
                      <InputText id="fuel_consumption" v-model="state.fuel_consumption" fluid/>
                    </div>
                    <!--  Цвет кузова -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Цвет кузова</label>
                      <Select v-model="state.directory_car_colors_id" :loading="loadingDirectoryCarColors"
                              :options="directoryCarColors"
                              optionLabel="name" optionValue="id" placeholder="Выберите цвет" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined
                    ...
                    <div>
                      <label for="seats_count"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Количество мест</label>
                    ...
                    <div>
                      <label for="additional_parameter_1"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 1</label>
                      <InputText id="additional_parameter_1" v-model="state.additional_parameter_1" fluid/>
                    </div>
                    <!-- Доп параметр 2 -->
                    <div>
                      <label for="additional_parameter_2"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 2</label>
                      <InputText id="additional_parameter_2" v-model="state.additional_parameter_2" fluid/>
                    </div>
                    <!-- Доп параметр 3 -->
                    <div>
                      <label for="additional_parameter_3"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 3</label>
                      <InputText id="additional_parameter_3" v-model="state.additional_parameter_3" fluid/>
                    </div>
                  </div>
                </Panel>
                ...
                <Panel header="Доп характеристики" toggleable collapsed>
                  <div class="grid gap-4 sm:grid-cols-1">
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_rear_view_camera" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_rear_view_camera" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Камера заднего вида?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_front_parking_sensors" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_front_parking_sensors" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Парктроники передние?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_rear_parking_sensors" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_rear_parking_sensors" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Парктроники задние?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_camera_360" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_camera_360" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Камеры 360?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_panorama" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_panorama" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Панорама?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_AUX" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_AUX" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          AUX?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_bluetooth" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_bluetooth" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Bluetooth?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_carplay" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_carplay" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Carplay?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_android_auto" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_android_auto" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          ANDROID AUTO?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_heated_seats" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_heated_seats" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Подогрев сидений?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_heated_windshield" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_heated_windshield" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Подогрев лобового стекла?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_driver_assistance" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_driver_assistance" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Ассистенты помощи водителю?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_railings" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_railings" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Рейлинги?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_isofix" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_isofix" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Isofix?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_hatch" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_hatch" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Люк?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_cruise_control" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_cruise_control" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Круиз контроль?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_armrest" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_armrest" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Подлокотник?
                        </label>
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="flex items-center gap-2">
                        <input id="characteristic_airbag_switch" type="checkbox"
                               ...
                               class="checkbox"/>
                        <label for="characteristic_airbag_switch" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                          Выключатель airbag?
                        </label>
                      </div>
                    </div>
                    <!--  Материал салона -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Материал салона</label>
                      <Select v-model="state.characteristic_directory_car_interior_materia_id" :loading="loadingDirectoryCarInteriorMateria"
                              :options="directoryCarInteriorMateria"
                              optionLabel="name" optionValue="id" placeholder="Выберите материал салона" showClear filter
                              class="w-full"
                      >
                        <template v-if="user.access.auto === 2" #header>
<!--                          <Button class="mt-4 ml-4" type="button" icon="pi pi-plus" label="Добавить" outlined-->
<!--                                  @click="isDirectoryCarInteriorMateriaAddDrawerOpen = true"/>-->
                    ...
                    <!--  Цвет салона -->
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Цвет салона</label>
                      <Select v-model="state.characteristic_directory_car_colors_id" :loading="loadingDirectoryCarColors"
                              :options="directoryCarColors"
                              optionLabel="name" optionValue="id" placeholder="Выберите цвет" showClear filter
                              class="w-full"
                      >
                    ...
                    <div>
                      <label for="characteristic_additional_parameter_1"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 1</label>
                      <InputText id="characteristic_additional_parameter_1" v-model="state.characteristic_additional_parameter_1" fluid/>
                    </div>
                    <!-- Доп параметр 2 -->
                    <div>
                      <label for="characteristic_additional_parameter_2"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 2</label>
                      <InputText id="characteristic_additional_parameter_2" v-model="state.characteristic_additional_parameter_2" fluid/>
                    </div>
                    <!-- Доп параметр 3 -->
                    <div>
                      <label for="characteristic_additional_parameter_3"
                             class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Доп параметр 3</label>
                      <InputText id="characteristic_additional_parameter_3" v-model="state.characteristic_additional_parameter_3" fluid/>
                    </div>
                  </div>
                </Panel>
              ...
              <div class="grid gap-4 sm:grid-cols-1">
                ...
                <div>
                  <label for="pts_body_number"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Номер кузова</label>
                  <InputText id="pts_body_number" v-model="state.pts_body_number" fluid/>
                </div>
                <!-- ПТС. Дата покупки -->
                <div>
                  <label for="pts_purchase_date"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Дата покупки</label>
                ...
                <div>
                  <label for="pts_cost_assessment"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Стоимость оценки авто</label>
                ...
                <div>
                  <label for="pts_cost_purchase"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Стоимость покупки авто</label>
                  <InputText id="pts_cost_purchase" v-model="state.pts_cost_purchase" fluid/>
                </div>
                <!-- ПТС Форма собственности -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Форма собственности</label>
                  <Select v-model="state.pts_directory_car_pts_ownership_id" :loading="loadingDirectoryCarPtsOwnership"
                ...
                <Divider type="dashed"/>
                <!-- ПТС. Файлы -->
                <FileGallery :items="state.pts_files" @onSelect="e => state.pts_upload_files = e.files"/>
              </div>
            </TabPanel>
            <TabPanel value="2">
              <div class="grid gap-4 sm:grid-cols-1">
                ...
                <div>
                  <label for="sts_expire_date"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Дата окончания</label>
                  <DatePickerWithMask :value="state.sts_expire_date" :key="state.sts_expire_date"
                                      @onChange="e => state.sts_expire_date = e"/>
                </div>
                <Divider type="dashed"/>
                <!-- СТС.. Файлы -->
                <FileGallery :items="state.sts_files" @onSelect="e => state.sts_upload_files = e.files"/>
              </div>
            </TabPanel>
            <TabPanel value="3">
              <div class="grid gap-4 sm:grid-cols-1">
                <!-- Размер колес -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Размер колес</label>
                  <Select v-model="state.to_directory_car_wheel_size_id" :loading="loadingDirectoryCarWheelSize"
                ...
                <!-- Резина -->
                <div>
                  <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Резина</label>
                  <Select v-model="state.to_directory_car_tires_type_id" :loading="loadingDirectoryCarTiresType"
                ...
                <div>
                  <label for="to_radio_code"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Код радио</label>
                ...
                <div>
                  <label for="to_beacon_place_1"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Место установки маяка 1</label>
                  <InputText id="to_beacon_place_1" v-model="state.to_beacon_place_1" fluid/>
                </div>
                <!-- Место установки маяка 2 -->
                <div>
                  <label for="to_beacon_place_2"
                         class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Место установки маяка 2</label>
            ...
            <TabPanel value="4">
              <div class="grid gap-4 sm:grid-cols-1">
                <!-- Фото -->
                <FileGallery :items="state.photo_files" accept="image/*" @onSelect="e => state.photo_upload_files = e.files"/>
              </div>
            </TabPanel>
            <TabPanel value="5">
              <!-- Прочие файлы -->
  ...
  <AddDirectoryDrawer
      ...
      @onAdd="onDirectoryCarCharacteristicColorsAdd" @onClose="isDirectoryCarCharacteristicColorsAddDrawerOpen = false"
  />
  <AddDirectoryDrawer
