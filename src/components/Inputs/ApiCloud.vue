        ...
        <div v-if="selectedVerification === 'all' || selectedVerification === 'fssp_physical'">
          <Panel header="ФССП поиск ФЛ" toggleable>
            ...
            <div v-else class="flex flex-col gap-2">
              ...
              <div>
                <span v-if="fssp_physical_verification.result.message">{{ fssp_physical_verification.result.message }}</span>
        ...
        <div v-if="selectedVerification === 'all' || selectedVerification === 'mvd_chekpassport'">
          <Panel header="МВД проверка паспорта РФ" toggleable>
            ...
            <div v-else class="flex flex-col gap-2">
              ...
              <div>
                <span v-if="mvd_chekpassport_verification.result.message">{{ mvd_chekpassport_verification.result.message }}</span>
                <span v-if="mvd_chekpassport_verification.result.info">{{ mvd_chekpassport_verification.result.info }}</span>
              </div>
            </div>
          </Panel>
        </div>
        ...
        <div v-if="selectedVerification === 'all' || selectedVerification === 'bankrot_searchstring'">
          <Panel header="Поиск в базе банкротств" toggleable>
            ...
            <div v-else class="flex flex-col gap-2">
              ...
              <div>
                <span v-if="bankrot_searchstring_verification.result.message">{{ bankrot_searchstring_verification.result.message }}</span>
                <span v-if="bankrot_searchstring_verification.result.info">{{ bankrot_searchstring_verification.result.info }}</span>
              </div>
            </div>
          </Panel>
        </div>
