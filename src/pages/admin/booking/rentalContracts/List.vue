...
const filters = ref({
    ...
    rental_days: {operator: FilterOperator.OR, constraints: [{value: null, matchMode: FilterMatchMode.EQUALS}]},
    accrued_total: {operator: FilterOperator.OR, constraints: [{value: null, matchMode: FilterMatchMode.EQUALS}]},
    paid_total: {operator: FilterOperator.OR, constraints: [{value: null, matchMode: FilterMatchMode.EQUALS}]},
    deposit_booking_total: {operator: FilterOperator.OR, constraints: [{value: null, matchMode: FilterMatchMode.EQUALS}]},
    ...
    <PageContainer :breadcrumbs="breadcrumbs">
        ...
        >
            <template #columns>
                ...
                <Column field="rental_days" header="Дней" dataType="numeric" headerStyle="width: 7rem; min-width: 7rem;" sortable>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="number" placeholder="Поиск..."/>
                    </template>
                </Column>
                <Column field="accrued_total" header="Стоимость" dataType="numeric" headerStyle="width: 7rem; min-width: 7rem;" sortable>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="number" placeholder="Поиск..."/>
                    </template>
                </Column>
                <Column field="paid_total" header="Оплата" dataType="numeric" headerStyle="width: 7rem; min-width: 7rem;" sortable>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="number" placeholder="Поиск..."/>
                    </template>
                </Column>
                <Column field="deposit_booking_total" header="Залог" dataType="numeric" headerStyle="width: 7rem; min-width: 7rem;" sortable>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="number" placeholder="Поиск..."/>
                    </template>
                </Column>
                <Column field="balance" header="Баланс" dataType="numeric" headerStyle="width: 7rem; min-width: 7rem;" sortable>
                    <template #filter="{ filterModel }">
                        <InputText v-model="filterModel.value" type="number" placeholder="Поиск..."/>
                    </template>
                </Column>
