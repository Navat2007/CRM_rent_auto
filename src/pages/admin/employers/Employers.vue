...
<template>
  <div class="w-full h-full bg-gray-100 dark:bg-gray-900 pt-4">
    ...
    <div v-else>
      <Table title="Таблица сотрудников" :items="items" :columns="columns" @onRowClick="handleRowClick">
        <button type="button" class="flex min-w-28 items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
