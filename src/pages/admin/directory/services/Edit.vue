...
const directoryTitle = 'Редактирование услуги при бронировании';
...
const handleEdit = (data) => {
  ...
  DirectoryService.editService(data).then((response) => {
    if (response.data) {
...
<template>
  <PageContainer :loading="loading" :breadcrumbs="breadcrumbs">
    <DirectoryServicesEditForm :title="directoryTitle" @onSubmit="handleEdit" @onDelete="isDeleteModalOpen = true" :item="item"/>
