...
const handleEdit = (data) => {
  ...
  DirectoryService.editCarClass(data).then((response) => {
    if (response.data) {
...
<template>
  <PageContainer :loading="loading" :breadcrumbs="breadcrumbs">
    <DirectoryCarClassesEditForm :title="directoryTitle" @onSubmit="handleEdit" @onDelete="isDeleteModalOpen = true" :item="item"/>
