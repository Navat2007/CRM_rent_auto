...
import DirectoryOperationTypesAddForm
    from "@components/Forms/Directory/OperationTypes/DirectoryOperationTypesAddForm.vue";
...
const directoryTitle = 'Добавление типа операции';
...
const handleAdd = (data) => {
  DirectoryService.addOperationType(data).then((response) => {
    if (response.data) {
...
<template>
  <PageContainer :breadcrumbs="breadcrumbs">
    <DirectoryOperationTypesAddForm :title="directoryTitle" @onSubmit="handleAdd"/>
