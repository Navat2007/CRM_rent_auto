...
const directoryParentTitle = 'ПТС Форма собственности авто';
const directoryTitle = 'Редактирование формы собственности авто';
const directoryUrl = 'car_pts_ownership';
