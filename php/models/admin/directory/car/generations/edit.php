...
$sql = "SELECT * FROM directory_car_generations WHERE id = '$id'";
$sqls[] = $sql;
...
if($error === 0){
    $sql = "UPDATE directory_car_generations SET name = '$name', directory_car_models_id = '$model_id', archive = '$active', last_user_id = '$user' WHERE id = '$id'";
    $sqls[] = $sql;
    $result = pg_query($conn, $sql);
}
