...
if ($error === 0) {
    ...
    INSERT INTO car (
             ...
             directory_car_brands_id,
             directory_car_models_id,
             directory_car_generations_id,
             directory_car_configurations_id,
             date_park_enter,
             date_park_exit,
             mileage,
             directory_car_statuses_id,
             body_condition,
             interior_condition,
             trunk_condition,
             need_refuel,
             ...
             directory_car_wheel_drive_id,
             directory_car_transmissions_id,
             fuel_tank_capacity,
             fuel_consumption,
             directory_car_colors_id,
             seats_count,
             additional_parameter_1,
             additional_parameter_2,
             additional_parameter_3,
             characteristic_rear_view_camera,
             characteristic_front_parking_sensors,
             characteristic_rear_parking_sensors,
             characteristic_camera_360,
             characteristic_panorama,
             characteristic_AUX,
             characteristic_bluetooth,
             characteristic_carplay,
             characteristic_android_auto,
             characteristic_heated_seats,
             characteristic_heated_windshield,
             characteristic_driver_assistance,
             characteristic_railings,
             characteristic_isofix,
             characteristic_hatch,
             characteristic_cruise_control,
             characteristic_armrest,
             characteristic_airbag_switch,
             characteristic_directory_car_interior_materia_id,
             characteristic_directory_car_colors_id,
             characteristic_additional_parameter_1,
             characteristic_additional_parameter_2,
             characteristic_additional_parameter_3,
             to_directory_car_wheel_size_id,
             to_directory_car_tires_type_id,
             to_radio_code,
             to_secret,
             to_beacon_place_1,
             to_beacon_place_2,
    ...
    VALUES (
            '$active', 
            '$state_number', 
            " . (empty($release_year) ? 'NULL' : "'" . $release_year . "'") . ",  
            '$directory_car_classes_id',
            '$directory_car_brands_id',
            '$directory_car_models_id',
            '$directory_car_generations_id',
            '$directory_car_configurations_id',
            " . (empty($date_park_enter) ? 'NULL' : "'" . $date_park_enter . "'") . ",  
            " . (empty($date_park_exit) ? 'NULL' : "'" . $date_park_exit . "'") . ",  
            '$mileage',
            '$directory_car_statuses_id',
            '$body_condition',
            '$interior_condition',
